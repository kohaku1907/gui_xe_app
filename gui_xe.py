...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.openExportCsvDialog())
    ...
    def exportCSV(self, values):
        ...
        if data:
            ...
            with open(name[0], 'w') as out_csv_file:
            ...
            msg.setText("Không có dữ liệu vui lòng chọn ngày khác ")
